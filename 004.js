...
var wbltan = [
    intvl.x, intvl.x,
    intvl.x, intvl.x, intvl.fifth,intvl.fifth,
   intvl.seventh,intvl.seventh,intvl.octave,intvl.octave,
   intvl.seventh,intvl.seventh +4,intvl.octave,intvl.octave +1,
   intvl.fourth,intvl.fourth,
   intvl.third,intvl.third,intvl.third,intvl.third,
   intvl.second,intvl.second,intvl.second,intvl.second,
...
var wbltn = [
    ...
    intvl.x, intvl.x, intvl.x, intvl.x,
    intvl.x, intvl.x, intvl.x, intvl.x,
    intvl.tone, intvl.tone, intvl.tone, intvl.tone,
    intvl.tone, intvl.tone, intvl.tone, intvl.tone,
    intvl.tone, intvl.tone, intvl.tone, intvl.tone,

    // intvl.min.third, intvl.min.third, intvl.min.third, intvl.min.third,
    // intvl.min.third, intvl.min.third, intvl.min.third, intvl.min.third,
    // intvl.min.third, intvl.min.third, intvl.min.third, intvl.min.third,
    // intvl.min.third, intvl.min.third, intvl.min.third, intvl.min.third,
    // intvl.tone, intvl.tone, intvl.tone, intvl.tone,
...
var lead = anna({
    ...
    osc: [
        ...
        { fn: sin, vol: 0.1, detune: 0 },
    ]
});

var b = baudio(function (t) {

    var la = lead(t, 220 * wbltan[flr((t + 4) * 10 % wbltan.length)]);
    var l2 = lead(t, 220 * wbltan[flr(t * 10 % wbltan.length)]);
    var l3 = lead(t, 440 * wbltan[flr((t + 2) * 10 % wbltan.length)]);
      var l4 = lead(t, 300 * wbltin[flr((t + 6) * 10 % wbltin.length)]);
       var l5 = lead(t, 300 * wbltin[flr((t + 5) * 10 % wbltin.length)]);
